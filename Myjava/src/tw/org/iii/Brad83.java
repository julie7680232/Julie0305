...
//		System.out.println((int)obj2);  //編譯不過,轉型失敗
		
		
		int i1 = 12;
		//Object obj1 = (Object) i1;  //=>auto-boxing           
		//Object obj1 = i1;   //=>auto-boxing
		
		Integer i2 = new Integer(34); 
		set.add(i2);
		set.add(i1); //i1 =>auto-boxing => new Integer(i)
		System.out.println(set.size());
		System.out.println(set);
		System.out.println("--------------------------------");
//		Iterator it = set.iterator();  //準備取出set之東西   //擁有迭代物件實體,不是new
//		while (it.hasNext()){  //有沒有下一個,回傳true或false
//			Object obj = it.next();   //拿出下一個給我
//			Integer i = (Integer)obj;  //物件強制轉型給我
//			System.out.println(i.floatValue());  //證明i是物件
//		}
		...
		for(Object obj :set){                  //與while的迴圈作的內容是一樣的,有兩種方法
			...
			//System.out.println((int)obj);   //第18.19列不行,但這裡可以,因為已經auto-boxing,不是toString
