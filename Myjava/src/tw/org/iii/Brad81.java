...
interface Brad703 extends Brad701{  //因為介面不可能有實作,所以不可能有implements,但是可以有繼承,此為子介面
	...
	public void int m1();   //因為第25列有實作,不知道要做第17列還是第10列,m1()方法傳回int
	public void m1(int a);
	public void m3();
}
interface Brad704 extends Brad701,Brad702{  //因為介面不可能有實作,所以不可能有implements,但是可以有繼承,而且可以繼承多個(多重繼承),但類別只能一個繼承
	public void m2();                         //介面沒有override
}
class Brad705 implements Brad703{
	public void m1(){}    //有大括號{}代表有實作
	public void m1(int a){}
	public void m3(){}
}
